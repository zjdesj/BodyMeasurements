...
def pro(calf):
  pcd, ind = calf.pcd.remove_statistical_outlier(nb_neighbors=2, std_ratio=0.03)
  calf.updatePCD(pcd)
  #calf.show_summary()
  ...
  #9-75 滤噪
  pcd, ind = calf.pcd.remove_statistical_outlier(nb_neighbors=2, std_ratio=0.2)
  calf.updatePCD(pcd)
  #calf.show_summary()
...
def convert(data):
  ...
  df.to_excel('/Users/wyw/Documents/Chaper2/github-code/segmentation-3D/data-result/reference/robs-norm.xlsx', index=False)
